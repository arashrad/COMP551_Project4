    ...
    while (epoch < n_epochs) and (not done_looping):
        ...
        for minibatch_index in range(n_train_batches):
            ...
            if (iter + 1) % validation_frequency == 0:
                ...
                training_losses = [train_model_loss(i)
...
if __name__ == '__main__':
    valid_rec, train_rec, test_rec =sgd_optimization_mnist(learning_rate=0.13, batch_size=100)
    records_file_maker("lreg_lr013_bs500.csv", train_rec, valid_rec, test_rec)
