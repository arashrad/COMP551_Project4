...
def test_mlp(learning_rate=0.01, L2_reg=0.0001, n_epochs=5, dataset='mnist.pkl.gz', batch_size=50, n_hidden=300):
    """
...
if __name__ == '__main__':
    valid_rec, train_rec, test_rec=test_mlp(learning_rate=0.01, L2_reg=0.0001, n_epochs=100, n_hidden=500, batch_size=500)
    records_file_maker("mlp1_hl500_lr01_reg0001.csv", train_rec, valid_rec, test_rec)
